...
At birth that jewel is pure, and shines brightly. As the vessel grows larger, it needs more nourishment from its surroundings, and thus its appetite for the energy of the material that it exists in, from which it has been fashioned, increases.

Thus the jewels becomes encrusted with the barnacles of life. Through the inputs of parents, siblings, teachers, and all those who wield power over these jewels &ndash; who actually have been tasked with the honour of keeping them safe and clean &ndash; the outer covering becomes encrusted, separating the nut from its shell, or the jewels from its vessel.
...
In addition, any transmissions from the outside are being intercepted by this shell that has formed around the jewel. Thus those messages from outside that the jewel&mdash;which responds to energy and frequency&mdash;receives are being affected by both the harmonics of the shell and the inner harmonics of the jewel that cannot penetrate the shell &ndash; and are being reflected and refracted in the inner chamber in which the jewel resides.

Let's take a closer look at what is happening here. I am simplifying it, because there are details that I am glossing over. But bear with me, and hopefully you will get the picture.

Imagine a jewel that is vibrating in a chamber, and these vibrations, though dampened, are sending out certain frequencies&ndash; which have nowhere to go. These vibrating in the chamber itself will begin to resonate, both harmonically and disharmonically. Eventually, the information will become so confusing, being impossible to differentiate between those messages that are coming from the jewels itself and those that are produced as a result of the internal noise that is continuously reverberating in the chamber itself. In addition, these extraneous frequencies and sounds would interfere with any information that is being received or being transmitted.
...
Another effect is the influence of all the noise in the chamber, both positive and negative, on the stream of messages being received.

Before continuing, we have to ask a pertinent question here. Where is the information that is being received by this jewel being transmitted to? A certain amount is the feedback to keep the shell functioning properly. The rest ... well back along the channel that is receiving from faraway, not from the shell surrounding it.

Now that ends up at the receiving station, where something looks at the message, and has to decide where to deliver it. If it is a good message, it goes into the G-d stream. If it is a bad message, it goes to those who deal with bad messages. Which will depend on how bad it is.

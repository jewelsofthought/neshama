...
The Merkava Descent, as taught my Martha-Joy Aft, is correct (even if only for this time and this place). It is our inheritance - a portal to another world, perhaps the "other world", that is part of our true inheritance, in addition to this one.
...
- Quanta not continuous but discreet.
- Yet the "reality" of quanta can only be described with waves (and probability waves at that!).

Perhaps there is a medium (water - ether) which is affected by this energy. As the wave on the ocean is produced by the winds (_ruach_) that move across the waters, perhaps that is what these perturbations that all these quantum hypothesis are trying to describe.
...
It transpires that it, paradoxically, your Divine self that recognises Itself. It is "G-d knowing Itself".
...
- Revolution: if it is from the inside, it will only produce another version of what was. Often the same jail. Even the same inmates - just different prison guards/wardens.
...
Perhaps that is our evolutionary cycle. We begin as 2d (right/wrong; pain/pleasure; love/hate; good/bad; rich/poor...)/ Everything is a this (me), and a that - that is potentially against/for me. Upon connecting with someone/something else's heart (entering the heart space together), it becomes a recognisable 3d reality. Which is the reality we live in. It has not only length and breadth, but depth too. And now, and then (as has been recorded), we are embracing a 4th dimensional, imaginative, virtual reality that has strange laws and even stranger effect/beings.
...
To know, to experience, to perceive of something as relative, there needs to be an absolute frame (expressed as a point) of reference. Even if that frame is relative to some greater system, it becomes the "absolute", fixed point of reference. The Axis around which your whole world turns. In order to change my life I have to change this [Axis Mundi](axis_mundi.html) (the central pillar) upon which my whole life stands.

This is like the compass which needs one fixed foot in order know where the other is going.
...
It seems that the constraint that holds most of us, is around our lack of giving towards our parents, and thus our ancestors - upon whose shoulders we stand. We seem to lack in compassion and forgiveness even for those who bore us, and sustained us, until we were able to make our own decisions (even the bad ones). We have forgotten about [honour](honour.html), and respect and decency - which implies, nay requires, some sort of code or covenant. In the same way, and I think this is the root cause, we no longer pay respect to our Creator. But, like spoilt children, we resent what we have been provided, always looking at, and desiring, what we don't have - and never taking responisibility for the mess we ourselves have created.

Shamanically: "Magic of their Alchemical Union". Not personal. Shitty parents. Need to enter spirit, connect to your soul-purpose. As nothing can come into being with spirit, and spirit, working through them, enabled you to manifest. It is all spirit. Do not be lulled into thinking it is literal - that you are the real deal. The full package. That is foolish. There is so much more than you in this world...
...
- Prayer (words, breath)
- Movement (breathing, dance)
- Music

## Constraint

One needs to practise constraint prior to the event, not subsequent to it. The latter removes all pleasure, making the experience rather torturous. That is the role of the teacher/mentor, to constrain the pupil, and by constraining him, he attains his form. But before that, he needs to be anchored. This is important. First the person needs to anchored, fixed - in the beginning one could say tethered or chained to the goal. This is through an oath or vow that he or she needs to declare. Once his position has been fixed, the teacher can then begin to teach and the constraint will form the student, not break him or her.

### Choice

You have a choice:

1. That of being constrained by your own will
2. or not - then you are allowing yourself to be constrained by the will of another.
   Due to the truism that to overcome your own weaknesses is the most difficult battle of all, thus there are many defeated by their own desires. The conclusion is that one needs help. If one seeks help from another, one runs the risk of falling under the other's influence, and not really acting from one's truth.
...
### Attract/Reject - Pos/Neg

- In the physical universe, like rejects like and opposites attract.
- In the spiritual universe, the opposite occurs: Like attracts like, and opposites oppose.
  The counter force to that, is that we can only desire (which is "spiritual", not physical - which works on a purely pain/pleasure reaction) that which we do not have! Not the opposite of what we have...

Now the interesting aspect to this is that upon choosing, which is imposing constraints, you encounter, and attract, more choices. In other words, the "fruiting" happens through constraint. So through removing energy from extraneous attractions, one focuses more energy on the choice. Which then grown stronger. And thus produces more fruit. By choosing, and thus removing all the other possibilities ([wave collapse](wave_collapse.html))

However, if you continue to make no choice, and thus take no action, you reduce your choices, until you find yourself in a place of not being allowed to choose - a place of "no-choice", which, G-d forbid, is to be in the realm of true evil.

The felt reaction to the "no-choice", that of allowing some "other" impulse to direct your actions, is one "guilt", and in that place, the desire for constraint arises. [Remember, can only desire what we don't have. After (over-)indulging in one of my pleasures, a feeling of guilt arises. Guilt at having sinned. Guilt at having wasted pleasure. Added guilt because of the need to keep the sin secret. Which often is accompanied by lies... and more guilt. The only way of assuaging the guilt at this stage is by "penance", which means some sort of constraint (which could include pain/punishment). Thus the lack of constraint in that specific area is balanced by an excess of constraint in some other area - perhaps completely disconnected, but in most cases there is a threat that the [clairvoyant](clairvoyant.html) (one with clear vision) can see.

[NOTE: Clairvoyant: one with clear vision. We don't have any names for the other 5 senses. Just an edge here. There is the shaman, who walks between two worlds. There are many types of shamans: healing with herbs/medicine; soul work. They speak of him walking between two worlds. That is because he is interacting with the spirit of mother earth (_Shekhina_?). However, a clairvoyant, in my eyes (which is what I am) is one who sees the other world - whether Shaman or not. A _Mekubal_, is one who studies, empirically, phenomenologically, and theoretically, the other spiritual realms (he is generally not interested in the non-spiritual)]

> What is fear but the memory of pain, and the hope to avoid it in the future? What is love but the memory of pleasure, and the hope to encounter it in the future?

### Free Choice (Prayer )

> Free choice as a turning away

The image from the _Zohar_ is of G-d turning His Eye/I away, showing the whites of His Eye/I, in order to allow us to be human. In this picture, He Acts like a true lover, giving you the opportunity to reject Him (or Her).
...
Thus, the principle of _Chesed_, compassion, needs to be invoked, which allows for the imperfections of being human to acknowledged and integrated by allowing differences not to separate, but to unify and strengthen. The more heterogeneous environment is always the more robust, whereas the homogenous, tightly coupled environment is highly effective, and while it's rigidity allows it to protect itself, it is susceptible to sudden collapse as the failure of one component will likely cause cascading failures.
...
First, one has to learn who you are and for that...

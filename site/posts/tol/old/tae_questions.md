...
modified: 2022-01-29T18:52:17.257Z
---
...
1. [Tree of Life Network (ToLNET) TAE](#tree-of-life-network-tolnet-tae)
   ...
   15. [Support](#support-1)
   16. [Confidentiality](#confidentiality)
   17. [Responsibility](#responsibility)
   18. [Trust](#trust)
   19. [Transparency](#transparency-1)
   20. [Truthful](#truthful)
   21. [4 Noble TruthsNo stealing, no lying.](#4-noble-truthsno-stealing-no-lying)
   22. [Principles:](#principles)
   23. [Purpose](#purpose)
   24. [Goal](#goal)
   25. [1 million](#1-million)
   26. [The Tree](#the-tree)
   27. [One sentence statement:](#one-sentence-statement)
   28. [Parables](#parables)
   29. [Freedom:](#freedom)
   30. [Web:](#web-1)
   31. [Vision:](#vision)
   32. [Fractal coherence:](#fractal-coherence)
       1. [Triangles: smallest component](#triangles-smallest-component)
   33. [Unification](#unification)
   34. [Join the network](#join-the-network)
   35. [Affinity](#affinity)
   36. [Group dynamics:](#group-dynamics)
   37. [Sponsors](#sponsors)
   38. [Cluster](#cluster)
   39. [Truth temples](#truth-temples)
   40. [Communications network](#communications-network)

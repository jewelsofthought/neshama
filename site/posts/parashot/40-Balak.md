...
I say that there is a "universal" language though I hesitate to call it a language – unless we decide to define a language as a set of symbols or visions which are meaningful to the transmitter and the receiver. This could be sounds, shape, engravings, statues, images, etc. It could also be _"chashmal"_ – the silence that speaks – for to speak is to "communicate" symbols. One could call it a type of telepathy – soundless communication, a "mental" transfer of images. It is "as if" it was speaking. One can hear the words, but there is no voice.
</div>
